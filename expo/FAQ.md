...
**NOTE**:
- (1). Early registration will help us plan accordingly. It will be greatly appreciated if you register at your earliest convenience. 
...
### 4. I want to attend the EXPO but will not be presenting a poster. Do I still need to register?
...
### 5. What types of posters can I submit?
Any type of poster is welcome! Some examples include a recent AMS or AGU poster, an important past poster, a new poster showcasing your recent research advances, innovative ideas, or a non-science poster related to GSL.

We will collaborate with the GSL poster print service to ensure your posters are printed on time.

### 6. How is the poster location numbered?
...
Note: 
- (1). Only PDF format is accepted. Please convert other formats into PDF before uploading.
- (2). Name your poster using the following convention:   
        FirstLast_short-title.pdf
  
### 9. I will attend the EXPO in person. Do I need to upload a digital poster?
...
- (b) Join individual Google Meet sessions hosted by remote poster presenters during the online portion of the EXPO from 12:00 - 1:00 PM.
- (c) Join the conversation at the [EXPO](https://app.slack.com/client/E07JCDR0CG7/C0874BN97R9) slack channel.

### 11. How do I comment on a digital poster?
You can comment directly on the poster's PDF file inside the shared Google Drive. The poster author will receive automatic notifications about your comments. Click [this link](https://drive.google.com/file/d/1lpzmjV7QmNINx_f0A8OBvSQ-TsXo_gVt/view?usp=drive_link) for an example (scroll down to the bottom to see all available comments).
